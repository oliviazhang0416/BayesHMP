...
saveRDS(stanfit, file=paste0(mainDir,"/MRP/combined_cohort/data/stanfit_v6.RData"))

summary <- summary(stanfit)
saveRDS(summary, file=paste0(mainDir,"/MRP/combined_cohort/data/summary_v6.RData"))

post_samples <- rstan::extract(stanfit,
                         pars=c("b0","b_age","b_race","a"))
saveRDS(post_samples, file=paste0(mainDir,"/MRP/combined_cohort/data/post_samples_v6.RData"))
```
...
```{r,echo=F}
post_samples <- readRDS(paste0(mainDir,"/MRP/combined_cohort/data/post_samples_v6.RData"))
```
...
```{r}  
saveRDS(pop_est, file=paste0(mainDir,"/MRP/combined_cohort/data/results.3.v6.RData"))
```

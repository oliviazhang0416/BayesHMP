...
saveRDS(outcome_rep, file=paste0(mainDir,"/MRP/2015_cohort/data/outcome_rep.RData"))
```

```{r}
#store the predictive outcomes
outcome_rep <- readRDS(paste0(mainDir,"/MRP/2015_cohort/data/outcome_rep.RData"))
...
ggsave(paste0(mainDir,"/MRP/inserts/Diagnostics/Postcheck.2015.jpg"), p)
```

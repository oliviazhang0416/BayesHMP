...
saveRDS(outcome_rep, file=paste0(mainDir,"/MRP/2011_cohort/data/outcome_rep.RData"))
```

```{r}
outcome_rep <- readRDS(paste0(mainDir,"/MRP/2011_cohort/data/outcome_rep.RData"))
...
ggsave(paste0(mainDir,"/MRP/inserts/Diagnostics/Postcheck.2011.jpg"), p)
```
